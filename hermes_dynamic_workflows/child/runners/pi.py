...
def _pi_metadata(
    ...
    *,
    ...
    return {
        ...
        # Also under the generic key: _apply_child_metadata reads `session_id`
        # to populate the agent record, so without this the resumable session
        # never reaches the run record for a pi child.
